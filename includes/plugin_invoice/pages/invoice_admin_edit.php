						...
						<tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if(!isset($invoice['taxes']) || !count($invoice['taxes'])){
                                    ...
                                    foreach($invoice['taxes'] as $id=>$tax){  ?>
                                        ...
                                        <div class="dynamic_block">
                                            ...
                                            <input type="text" name="tax_percents[]" class="dynamic_clear" value="<?php echo isset($tax['percent']) ? htmlspecialchars(number_out($tax['percent'])) : '';?>" style="width:35px;">%

                                            <span class="invoice_tax_increment">

                                                <input type="hidden" name="tax_increment[]" class="dynamic_clear tax_increment" value="<?php echo isset($tax['increment']) ? $tax['increment'] : 0;?>">

                                                <input type="checkbox" name="tax_increment_checkbox" class="dynamic_clear tax_increment_checkbox" value="1" <?php echo isset($tax['increment']) && $tax['increment'] ? ' checked' : '';?>> <?php _e('incremental');?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        ...
                                        echo print_select_box($c,'user_id',$invoice['user_id'],'',false);
                        ...
                        <table class="tableclass tableclass_form tableclass_full" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="allowed_payment_method_check" value="1">
                            ...
                            if(class_exists('module_company',false) && module_company::is_enabled() && defined('COMPANY_UNIQUE_CONFIG') && COMPANY_UNIQUE_CONFIG && module_company::can_i('view','Company') && $invoice['customer_id'] > 0){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo print_select_box($company_list,'set_manual_company_id',isset($invoice['company_id']) ? $invoice['company_id'] : 0,'',_l('Default'),'name'); ?>
    ...
    <?php } ?>
                            ...
                            if(!$hide_tax){
                                ...
                                foreach($invoice['taxes'] as $invoice_tax){
                                    ...
                                    $rows[]=array(
                                        ...
                                        'extra'=>$invoice_tax['name'] . ' = '.$invoice_tax['percent'].'%',
                ...
                <script type="text/javascript">
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_rows tableclass_full">
                        ...
                        <?php if(class_exists('module_finance',false) && module_finance::is_plugin_enabled() && module_finance::can_i('view','Finance') && module_finance::is_enabled() && is_file('includes/plugin_finance/pages/finance_invoice_edit.php') && module_config::c('invoice_show_finances',1)){
